...
const POTENTIAL_STOCK = ["Long Sword", "Rapier", "Falchion", "Saber", "Spear", "Javelin", "Glaive", "Hatchet", "Hand Axe", "Janto", "Dagger", "Stiletto", "Pike", "Ranseur", "Machette"]
...
func _on_AnimatedSprite_animation_finished():
	if active:
		...
		if animation() == "Idle":
			play(["Idle", "Idle", "Idle", "Idle", "Idle", "Idle", "Axe", "Club", "Dagger", "Spear", "Sword"][randi()%11])
		else:
			play("Idle")
