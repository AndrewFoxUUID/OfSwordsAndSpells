...
class Main():
    ...
    def __init__(self):
        pygame.init()
        pygame.display.set_caption("Version 3: Voronoi Enhanced Non-Periodic Sine Curve")
    ...
    def remap(self):
        point_arr = [[0, 0] for i in range(5000)]
        for i in range(5000):
            point_arr[i][0] = random.randint(-50, 1050)
            point_arr[i][1] = random.randint(0, 550)
        ...
        #for line in lines:
        #    pygame.draw.line(self.layer1, (0, 0, 0, 255), line.coords[0], line.coords[1])
